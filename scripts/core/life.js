...
export default class Life {
    constructor(ctx){
        ...
        this.chosenPercent = this.percentsLife[Math.floor(Math.random() * this.percentsLife.length)]
    }

    repairAircraft(){
        GAME_CONFIG.player.life = GAME_CONFIG.player.life + this.chosenPercent > 100 ? 100 :  GAME_CONFIG.player.life + this.chosenPercent;
        const sound = new Audio();
        sound.src = "../assets/sounds/energy.ogg";
        sound.play();
