...
export default class Enemy2 {
    constructor(ctx) {
        ...
        this.sprite.src = ".././assets/img/enemies/enemy4.png";
    ...
    fire() {
        enemiesProjectiles.push(new Projectile(this.ctx, this.x + 5, this.y + this.height - 80));
        enemiesProjectiles.push(new Projectile(this.ctx, this.x + 50, this.y + this.height - 80));
    }
...
class Projectile {
    constructor(ctx, x, y) {
        ...
        this.sound.src = ".././assets/sounds/enemy4_fire.wav";
