...
export default class Enemy5{
    ...
    explode() {
        explosions.push(new Explosion(this.ctx, (this.x + this.width) / 2 , this.y - 150, 50, true));
    }

    fire(){
        enemiesProjectiles.push(new Projectile(this.ctx, (this.x + this.width / 2) - 18 , this.y + this.height - 18));     
    }
